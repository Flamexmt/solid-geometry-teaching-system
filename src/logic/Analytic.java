...
public class Analytic {
	...
	private int UnitLength=10;//描点的间隔
	private Drawer d;
	...
	public void DrawXoy(Xoy_model xoymod) {
		...
		g.drawString("0",(int)xoymod.getOriginX() + 2,(int)xoymod.getOriginY() +12); //画原点数字
		for(int i = 1 ;(int)xoymod.getOriginX()+i*UnitLength<xoymod.getXend().getX();i++)
		{
//			g.drawLine((int)xoymod.getOriginX()+i*UnitLength,(int)xoymod.getOriginY()-1,(int)xoymod.getOriginX()+i*UnitLength,(int)xoymod.getOriginY()-6);//画X轴正向的小竖线
//			g.drawLine((int)xoymod.getOriginX()-i*UnitLength, (int)xoymod.getOriginY()-1, (int)xoymod.getOriginX() - i*UnitLength, (int)xoymod.getOriginY()-6);//画X轴负向的小竖线
